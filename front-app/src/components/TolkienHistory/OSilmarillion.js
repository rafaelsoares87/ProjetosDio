...
const OSilmarillion = ()=>{
    return( 
        <>
            ...
            <Grid>
                <h2 className="card-title  text-center">O Silmarillion</h2>
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <blockquote class="blockquote mb-0">
                                    ...
                                    <img src="https://ovicio.com.br/wp-content/uploads/2019/02/20190211-o-silmarillion-810x628.png" class="card-img-top" alt="livro O Silmarillion "></img> <br/> <br/>
                                    <footer class="blockquote-footer">Fontes <cite title="Source Title">Livro: O Silmarillion </cite></footer>
                                </blockquote>
